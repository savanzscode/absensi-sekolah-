...
<head>
	...
	<link rel='shortcut icon' href='<?= $homeurl ?>/favicon.png' />
			...
			<section class='sidebar'>
				...
				<ul class=' sidebar-menu tree data-widget=' tree>
					...
					<?php if ($pengawas['level'] == 'admin') : ?>
						...
						<li class='treeview'>
							...
							<ul class='treeview-menu'>
								...
								<li><a href='?pg=tugas'><i class='fas fa-angle-double-right  fa-fw'></i> <span>Pembahasan Soal</span></a></li>
					...
					<?php if ($pengawas['level'] == 'pengawas') : ?>
						<li class='treeview'><a href='?pg=siswa'><i class="fas side-menu-icon fa-user-friends fa-lg fa-fw"></i> <span>Peserta Ujian</span></a></li>
						<li><a href='?pg=statuspeserta'><i class="fas side-menu-icon fa-users-cog fa-fw"></i> <span>Status Peserta</span></a></li>
