                ...
                <div class="col-lg-4">
                    <div class="small-box bg-green ">
						...
						<div class='inner'>
										...
										<h3><span name='token' id='isi_token'><?= $token['token'] ?></h3>
										Jadwal Ujian
									</div>
                ...
                <div class="box-body">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item"><img src="../dist/img/support.png" width="45" alt="">
                            <a href="https://github.com/savanzscode" target="_blank" class="btn btn-success">
                                <i class="fas fa-globe    "></i> Website
                            </a></li>
                            <li class="list-group-item">
    <img src="../dist/img/support.png" width="45" alt="">
    <a href="https://wa.me/+6285172442919" target="_blank" class="btn btn-success">
