...
if ($pg == 'ubah') {
    ...
    if ($pengawas['level'] == 'admin') {
        $exec = mysqli_query($koneksi, "UPDATE mapel SET kode='$kode', idpk='$idpk',nama='$nama',level='$level',jml_soal='$jml_soal',jml_esai='$jml_esai',status='$status',idguru='$guru',bobot_pg='$bobot_pg',bobot_esai='$bobot_esai',tampil_pg='$tampil_pg',tampil_esai='$tampil_esai',kelas='$kelas',opsi='$opsi', kkm='$kkm' WHERE id_mapel='$id'");
        if ($exec) {
            echo "OK";
        }
    } elseif ($pengawas['level'] == 'guru') {
        $exec = mysqli_query($koneksi, "UPDATE mapel SET kode='$kode', idpk='$idpk',nama='$nama',level='$level',jml_soal='$jml_soal',jml_esai='$jml_esai',status='$status',bobot_pg='$bobot_pg',bobot_esai='$bobot_esai',tampil_pg='$tampil_pg',tampil_esai='$tampil_esai',kelas='$kelas',opsi='$opsi',kkm='$kkm'  WHERE id_mapel='$id'");
        if ($exec) {
            echo "OK";
        }
    }
